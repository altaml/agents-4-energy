...
export const handler: Schema["invokePlanAndExecuteAgent"]["functionHandler"] = async (event) => {
    ...
    try {
        ...
        const replannerPrompt = ChatPromptTemplate.fromTemplate(
            ...
            The AI has tools to query well production databases, search well files, invoke petroleum engineering agents, make plots and tables, and perform calculations.
            Assign the role "ai" to every step unless it truly requires physical human action (e.g. field inspection). Almost all data retrieval, analysis, and reporting steps should be "ai".
